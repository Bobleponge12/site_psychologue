...
if (!empty($_POST['email']) && !empty($_POST['name'])) {
  try {
    ...
    $mail->Password   = 'atfcqjkafzyjrrws';             //SMTP password
...
<head>
  ...
  <script src='https://kit.fontawesome.com/a076d05399.js'ossorigin='anonymous'></script>
...
<body class="fondBody">
  ...
  <header class="container-fluid">
      <div class="header-text">
        <h2 style="font-size:50px">Mathilde <span class="texteBlanc">GIRON</span></h2>
        <h3>Psychologue clinicienne <span class="texteBlanc">Toulouse</span></h3>
          <a class="btn btn-primary mt-2 me-3" href="tel:0682254811" role="button"><i class='fas fa-phone'></i>
Téléphone</a>
          <a class="btn btn-primary mt-2 ms-3" href="#ancreForm" role="button"><i class='fas fa-envelope-square'></i>&nbsp
Mail &nbsp &nbsp;
  ...
  <div>
    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">
          <img src="./img/psy/kisspng-psychology-symbol-logo-sign-concept-5af5d10100ec74.7458124215260592650038.webp" width="30" height="15" alt="Logo psychologue" style="border-radius:50% ;">
        </a>
    ...
    <section id="ancreForm" class="container-fluid title">
